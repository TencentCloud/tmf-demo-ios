...
- (void)layoutSubviews {
    ...
    self.textLabel.frame = CGRectFlatMake(CGRectGetMaxX(self.imageView.frame) + kImageViewMarginRight, CGRectGetMinY(self.imageView.frame) + 5,
        labelWidth, CGRectGetHeight(self.textLabel.bounds));
    ...
    self.detailTextLabel.frame = CGRectFlatMake(CGRectGetMinX(self.textLabel.frame), CGRectGetMaxY(self.textLabel.frame) + kTextLabelMarginBottom,
        labelWidth, fmin(detailLimitHeight, detailSize.height));
}

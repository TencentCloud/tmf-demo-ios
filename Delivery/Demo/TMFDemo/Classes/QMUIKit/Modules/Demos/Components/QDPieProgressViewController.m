...
- (void)viewDidLayoutSubviews {
    ...
    self.progressView1.frame = CGRectSetXY(self.progressView1.frame, horizontalInset,
        CGRectGetMinYVerticallyCenterInParentRect(self.section1.bounds, self.progressView1.frame)
            - 6);  // 因为下面有个label，因此这里向上偏一点以让视觉上更平衡
    self.titleLabel1.frame = CGRectMake(CGRectGetMinX(self.progressView1.frame), CGRectGetMaxY(self.progressView1.frame) + 9,
        CGRectGetWidth(self.progressView1.bounds), CGRectGetHeight(self.titleLabel1.bounds));
    self.slider.frame = CGRectMake(CGRectGetMaxX(self.progressView1.frame) + progressView1MarginRight,
        CGRectGetMidY(self.progressView1.frame) - CGRectGetMidY(self.slider.bounds),
        CGRectGetWidth(self.scrollView.bounds) - CGRectGetMaxX(self.progressView1.frame) - progressView1MarginRight - horizontalInset,
    ...
    self.progressView2.frame = CGRectSetXY(
        self.progressView2.frame, horizontalInset + 5, CGRectGetMinYVerticallyCenterInParentRect(self.section2.bounds, self.progressView2.frame));
    [self.titleLabel2 sizeToFit];
    self.titleLabel2.frame = CGRectSetXY(self.titleLabel2.frame, CGRectGetMinX(self.slider.frame),
        CGRectGetMinYVerticallyCenterInParentRect(self.section2.bounds, self.titleLabel2.frame));
    ...
    [self.titleLabel3 sizeToFit];
    self.titleLabel3.frame = CGRectSetXY(self.titleLabel3.frame, CGRectGetMinX(self.slider.frame),
        CGRectGetMinYVerticallyCenterInParentRect(self.section3.bounds, self.titleLabel3.frame));

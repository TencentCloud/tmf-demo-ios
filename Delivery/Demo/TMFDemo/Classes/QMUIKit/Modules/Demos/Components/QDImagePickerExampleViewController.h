...
@interface QDImagePickerExampleViewController
    : QDCommonGroupListViewController <QMUIAlbumViewControllerDelegate, QMUIImagePickerViewControllerDelegate,
          QDMultipleImagePickerPreviewViewControllerDelegate, QDSingleImagePickerPreviewViewControllerDelegate>

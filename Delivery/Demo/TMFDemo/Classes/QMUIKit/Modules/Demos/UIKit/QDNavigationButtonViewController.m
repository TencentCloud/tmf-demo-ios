...
- (void)initDataSource {
    self.dataSource = [[QMUIOrderedDictionary alloc]
        initWithKeysAndObjects:kSectionTitleForNormalButton,
        [[QMUIOrderedDictionary alloc] initWithKeysAndObjects:@"[系统]文本按钮", @"", @"[QMUI]文本按钮", @"", nil], kSectionTitleForBoldButton,
        [[QMUIOrderedDictionary alloc] initWithKeysAndObjects:@"[系统]加粗文本按钮", @"", @"[QMUI]加粗文本按钮", @"", nil],
        kSectionTitleForImageButton, [[QMUIOrderedDictionary alloc] initWithKeysAndObjects:@"[系统]图片按钮", @"", @"[QMUI]图片按钮", @"", nil],
        kSectionTitleForBackButton, [[QMUIOrderedDictionary alloc] initWithKeysAndObjects:@"[系统]返回按钮", @"", @"[QMUI]返回按钮", @"", nil],
        kSectionTitleForCloseButton,
        [[QMUIOrderedDictionary alloc] initWithKeysAndObjects:@"[QMUI]关闭按钮", @"在 present 的场景经常使用这种关闭按钮", nil], nil];
}
...
- (void)didSelectCellWithTitle:(NSString *)title {
    if ([title isEqualToString:@"[系统]文本按钮"]) {
        ...
        UIBarButtonItem *item =
            [UIBarButtonItem qmui_itemWithButton:[[QMUINavigationButton alloc] initWithType:QMUINavigationButtonTypeNormal title:@"文字"] target:nil
                                          action:NULL];
        self.navigationItem.rightBarButtonItems = @[item];
        ...
        UIBarButtonItem *item =
            [UIBarButtonItem qmui_itemWithButton:[[QMUINavigationButton alloc] initWithType:QMUINavigationButtonTypeBold title:@"加粗"] target:nil
                                          action:NULL];
        self.navigationItem.rightBarButtonItems = @[item];
        ...
        UIBarButtonItem *item = [UIBarButtonItem qmui_backItemWithTarget:self
                                                                  action:@selector(handleBackButtonEvent:)];  // 自定义返回按钮要自己写代码去 pop 界面

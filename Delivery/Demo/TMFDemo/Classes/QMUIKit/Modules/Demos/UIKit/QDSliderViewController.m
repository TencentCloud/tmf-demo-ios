...
- (void)viewDidLayoutSubviews {
    ...
    self.slider.frame = CGRectMake(padding.left, CGRectGetMaxY(self.label1.frame) + 16,
        CGRectGetWidth(self.view.bounds) - UIEdgeInsetsGetHorizontalValue(padding), CGRectGetHeight(self.slider.frame));

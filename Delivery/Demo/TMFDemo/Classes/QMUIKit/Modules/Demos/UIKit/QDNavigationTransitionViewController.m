...
- (void)viewDidLayoutSubviews {
    ...
    self.stateLabel.frame = CGRectMake(
        24, self.qmui_navigationBarMaxYInViewCoordinator + 24, CGRectGetWidth(self.view.bounds) - 24 * 2, CGRectGetHeight(self.stateLabel.frame));
}
...
// QMUICommonViewController 默认已经实现了 QMUINavigationControllerDelegate，如果你的 vc 并非继承自 QMUICommonViewController，则需要自行实现
// <QMUINavigationControllerDelegate>。 注意，这一切都需要在 QMUINavigationController 里才有效。
#pragma mark - <QMUINavigationControllerDelegate>

- (void)navigationController:(QMUINavigationController *)navigationController
    poppingByInteractiveGestureRecognizer:(UIScreenEdgePanGestureRecognizer *)gestureRecognizer
              viewControllerWillDisappear:(UIViewController *)viewControllerWillDisappear
                 viewControllerWillAppear:(UIViewController *)viewControllerWillAppear {

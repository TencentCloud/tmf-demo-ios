...
- (void)layoutSubviews {
    ...
    _shouldShowImageSeparatorLayer.frame
        = CGRectMake(0, CGRectGetMaxY(_shouldShowImageLabel.frame) + 14, CGRectGetWidth(self.contentView.bounds), PixelOne);
    ...
    _imagePositionSegmented.center = CGPointMake(
        flat(CGRectGetWidth(self.contentView.bounds) - CGRectGetWidth(_imagePositionSegmented.frame) / 2), _imagePositionLabel.center.y);
    ...
    _horizontalAlignmentSegmented.center = CGPointMake(
        flat(CGRectGetWidth(self.contentView.bounds) - CGRectGetWidth(_horizontalAlignmentSegmented.frame) / 2), _horizontalAlignmentLabel.center.y);
    ...
    _verticalAlignmentSegmented.center = CGPointMake(
        flat(CGRectGetWidth(self.contentView.bounds) - CGRectGetWidth(_verticalAlignmentSegmented.frame) / 2), _verticalAlignmentLabel.center.y);

...
- (void)viewDidLayoutSubviews {
    ...
    _shapeLayer1.frame = CGRectMake(CGFloatGetCenter(CGRectGetWidth(self.view.bounds), kLayerSizeValue),
        self.qmui_navigationBarMaxYInViewCoordinator + minY, kLayerSizeValue, kLayerSizeValue);

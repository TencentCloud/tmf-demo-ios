...
- (void)viewDidLayoutSubviews {
    ...
    self.indicatorView.frame = CGRectMake(CGFloatGetCenter(CGRectGetWidth(self.scrollView.bounds), CGRectGetWidth(self.indicatorView.bounds)),
                                          minY,
                                          CGRectGetWidth(self.indicatorView.bounds),
                                          CGRectGetHeight(self.indicatorView.bounds));

...
- (void)viewDidLayoutSubviews {
    ...
    self.lineHeightLabel.frame
        = CGRectFlatMake(padding.left, CGRectGetMaxY(self.fontPointSizeLabel.frame) + 16, contentWidth, CGRectGetHeight(self.lineHeightLabel.frame));
    self.fontPointSizeSlider.frame
        = CGRectFlatMake(padding.left, CGRectGetMaxY(self.lineHeightLabel.frame) + 16, contentWidth, CGRectGetHeight(self.fontPointSizeSlider.frame));

    self.exampleLabel.frame
        = CGRectFlatMake(padding.left, CGRectGetMaxY(self.fontPointSizeSlider.frame) + 40, contentWidth, QMUIViewSelfSizingHeight);
}
